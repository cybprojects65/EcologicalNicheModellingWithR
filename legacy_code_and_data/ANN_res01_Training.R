...
#GENERAL PARAMETERS
env_data_folder<-"/media/gp/228E389F8E386E03/All ENMs EcoScope/Environmental Parameters/Res 01/Historical 2019"
presence_data_folder<-"/media/gp/228E389F8E386E03/All ENMs EcoScope/Presence Records/Fish"
absence_data_folder<-"/media/gp/228E389F8E386E03/All ENMs EcoScope/Absence Records/Fish"
presence_data_folder_nf<-"/media/gp/228E389F8E386E03/All ENMs EcoScope/Presence Records/Non Fish"
absence_data_folder_nf<-"/media/gp/228E389F8E386E03/All ENMs EcoScope/Absence Records/Non Fish"

output_folder<-"./ENM_res_01_2019_F"

vip_spp<-read.csv("list_of_vip_species.txt")
allspp<-vip_spp$species_name
...
for (species in allspp){
  ...
  for (file in all_asc_files){
    ...
    if (length(grid_of_points)==0){
      ...
      pf<-paste0(presence_data_folder,"/",presence_file)
      if (!file.exists(pf)){
        pf<-paste0(presence_data_folder_nf,"/",presence_file)
      }
      presence<-read.table(pf,header = TRUE, sep=",")  
  ...
  #omitted feature: training_set$Sea_Ice_Concentration_res_01_annual_years_2019_Clim_scen_historical_global[which(is.na(training_set["Sea_Ice_Concentration_res_01_annual_years_2019_Clim_scen_historical_global"]))]<-0
  training_set$t<-0
